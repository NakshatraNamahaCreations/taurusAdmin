  ...
  return (
    ...
    >
      ...
      >
                  ...
                  <thead style={{ backgroundColor: "#f8fafc", color: "#334155", fontWeight: 600 }}>
                    <tr>
                      ...
                      <th style={{ padding: "12px", fontSize: "12px" }}>Serial</th>
                       <th style={{ padding: "12px" }}>System No</th>
        ...
        {product.systemNumber || "—"}
      </td>
            <td style={{ padding: "12px", fontSize: "12px", color: "#475569", maxWidth: "180px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
        {product.description || "—"}
      </td>
                        <td style={{ padding: "12px" }}>
                          <FaEdit
                            style={{ color: "#0d6efd", cursor: "pointer", marginRight: "3px", fontSize: "15px" }}
                            onClick={() => handleEdit(product)}
                          />
                            <FaInfoCircle
    style={{ color: "#64748b", cursor: "pointer", fontSize: "15px",marginRight: "3px" }}
    onClick={() => {
...
>
  ...
  >
    ...
    >
      <FaBox style={{ color: "#4f46e5" }} /> Product Details
    </Modal.Title>
  </Modal.Header>
      ...
      <Row>
        <Col md={6}>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ fontSize: "14px" }}>{viewProduct.brandName}</div>
          </div>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ fontSize: "14px" }}>
              <Badge bg="light" text="dark" style={{ fontSize: "13px", padding: "4px 10px" }}>
                {getProductTypeIcon(viewProduct.productType)} {viewProduct.productType}
              </Badge>
            </div>
          </div>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ fontSize: "14px", fontWeight: 600 }}>₹{viewProduct.price}</div>
          </div>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ fontSize: "14px" }}>
              {viewProduct.depositAmount ? `₹${viewProduct.depositAmount}` : "—"}
            </div>
          </div>
        </Col>
        ...
        <Col md={6}>
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ fontSize: "14px" }}>{viewProduct.quantity}</div>
          </div>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ fontSize: "14px" }}>
              <Badge
                bg={viewProduct.availableQty > 0 ? "success" : "danger"}
                text="white"
                style={{ fontSize: "13px", padding: "4px 10px" }}
              >
                {viewProduct.availableQty}
              </Badge>
            </div>
          </div>

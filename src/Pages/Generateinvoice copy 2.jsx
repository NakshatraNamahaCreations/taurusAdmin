                        ...
                        <div className="col-md-6">
                            <div className="d-flex align-items-center">
                                <img 
                                    ...
                                    alt="Company Logo" 
                                    className="me-3" 
                                    style={{ width: '70px', height: '70px', objectFit: 'cover', borderRadius: '10px', border: '3px solid rgba(255,255,255,0.3)' }}
                                />
                                <div>
                                    {invoicename.map((data)=>(
                                      <h3 className="mb-1" style={{ fontSize: '20px', fontWeight: 'bold' }}>
                                        {data.invoiceName}
                                    </h3>
                                    ))}
